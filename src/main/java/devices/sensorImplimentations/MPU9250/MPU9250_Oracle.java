...
public class MPU9250_Oracle implements Accelerometer, Gyroscope, Magnetometer, Thermometer, Runnable
{
    ...
    private void initAK8963() throws InterruptedException, IOException
    {
        ...
        write(Device.ak8963, Registers.AK8963_CNTL, (byte)(magScale.getValue() << 4 | Registers.M_MODE.getValue())); // Set magnetometer data resolution and sample ODR
        Thread.sleep(10);
    }
    ...
    private void initMPU9250() throws IOException, InterruptedException
    {
        ...
        c = read(Device.mpu9250, Registers.ACCEL_CONFIG2.getValue()); // get current ACCEL_CONFIG2 register value
